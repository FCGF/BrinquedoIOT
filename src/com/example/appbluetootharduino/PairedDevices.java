...
public class PairedDevices extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		 ...
		 * Adiciona um título à lista de dispositivos pareados utilizando o
		...
		/*
		 * Cria um modelo para a lista e o adiciona à tela. Se houver
		 * dispositivos pareados, adiciona cada um à lista.
		 */
	...
	/*
	 * Este método é executado quando o usuário seleciona um elemento da
	 * lista.
	 */
	@Override
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		/*
		 * Extrai nome e endereço a partir do conteúdo do elemento
		 * selecionado. Nota: position-1 é utilizado pois adicionamos um
		 * título à lista e o valor de position recebido pelo método é
		...
		/*
		 * Utiliza um Intent para encapsular as informações de nome e
		 * endereço. Informa à Activity principal que tudo foi um sucesso!
